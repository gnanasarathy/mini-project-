...
def actionauthor():
    messagebox.showinfo("Author", "mini project\nDepartment: IT\nCollege:SREC")
...
root = Tk();
root.title('GIRISH CALCI');
root.geometry('380x300+200+250');
Titlelabel = Label(root, fg = 'green' , font = 'none 10 bold underline' ,text = 'GGG Calculator', compound = CENTER)
